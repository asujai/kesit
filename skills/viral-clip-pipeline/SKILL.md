...
│       ├── spec.json                   <-- O güne özel BİLDİRİMSEL kurgu tanımı (TR + EN)
...
│   ├── youtube\
│   │   └── Gun_X\                      <-- Türkçe YouTube Shorts vitrini (Nihai paket)
│   │       ├── Gun_X_Shorts.mp4        <-- TR gömülü altyazılı dikey video
│   │       ├── Gun_X_Shorts_Kapak.jpg  <-- TR dikey kapak görseli (Thumbnail)
│   │       └── YOUTUBE_POST_BILGILERI.md
│   └── instagram\
│       └── Gun_X\                      <-- Türkçe Instagram Reels vitrini
│           ├── Gun_X_Reels.mp4         <-- TR dikey Reels videosu
│           └── INSTAGRAM_POST_BILGILERI.md
│
├── ingilizce\                          <-- İngilizce Yayın Vitrinleri (Global)
│   ├── youtube\
│   │   └── Gun_X\                      <-- İngilizce YouTube Shorts vitrini
│   │       ├── Gun_X_Shorts.mp4        <-- EN gömülü altyazılı dikey video
│   │       ├── Gun_X_Shorts_Kapak.jpg  <-- EN dikey kapak görseli (Thumbnail)
│   │       └── YOUTUBE_POST_BILGILERI.md (EN)
│   └── instagram\                      <-- Geleceğe hazır (Şimdilik video üretilmez)
│
├── assets\
...
* **Katı İlke (Release Gate):** `turkce/` ve `ingilizce/` altındaki yayın vitrinleri `QualityGate` onayı olmadan ASLA güncellenemez. Başarısız veya doğrulanmamış render vitrine kopyalanmaz.
