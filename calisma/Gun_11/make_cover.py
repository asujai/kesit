...
def create_shorts_thumbnail():
    work_dir = os.path.join('calisma', 'Gun_11')
    raw_cover_path = os.path.join(work_dir, 'cand_cover_2.jpg')
    output_cover_path = os.path.join(work_dir, 'Gun_11_Shorts_Kapak.jpg')
    ...
    badge_text = 'PSİKOLOJİK ÇÖZÜM'
    line1 = 'TEMBELLİĞİ BİTİREN YÖNTEM:'
    line2 = '"HİÇBİR ŞEY YAPMA!"'
    ...
    print(f"[Cover] Saved Turkish thumbnail to: {output_cover_path}")
