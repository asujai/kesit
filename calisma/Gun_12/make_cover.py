...
def create_shorts_thumbnail():
    work_dir = os.path.join('calisma', 'Gun_12')
    raw_cover_path = os.path.join(work_dir, 'cand_cover_5.0.jpg')
    output_cover_path = os.path.join(work_dir, 'Gun_12_Shorts_Kapak.jpg')
    ...
    badge_text = 'PSİKOLOJİK FORMÜL'
    line1 = 'AŞIRI DÜŞÜNMEYİ BİTİREN'
    line2 = '"%40 - %70 KURALI!"'
    ...
    bg.convert('RGB').save(output_cover_path, 'JPEG', quality=95)
    print(f"[Cover] Saved: {output_cover_path}")
