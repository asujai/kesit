...
def create_shorts_thumbnail(lang="tr"):
    work_dir = os.path.join("calisma", "Gun_6")
    raw_cover_path = os.path.join(work_dir, "cover_bg.jpg")
    is_en = (lang == "en")
    output_cover_path = os.path.join(work_dir, "Gun_6_Shorts_Kapak_EN.jpg" if is_en else "Gun_6_Shorts_Kapak.jpg")
    ...
    if is_en:
        badge_text = "SELF-CHECK"
        line1 = "ARE YOU SCREEN ADDICTED?"
        line2 = "8 WARNING SIGNS!"
    else:
        badge_text = "KENDİNİ TEST ET"
        line1 = "EKRAN BAĞIMLISI MISIN?"
        line2 = "BU 8 İŞARETE DİKKAT!"
